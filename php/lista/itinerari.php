...
$sql = "SELECT * FROM itinerari" . $type . " GROUP BY id_itinerario ORDER BY id_itinerario DESC LIMIT " . ($page - 1) * $elementsPerPage . ", " . $elementsPerPage;
$result = $conn->prepare($sql);
$result->execute();
$itinerari = $result->fetchAll(PDO::FETCH_ASSOC);
