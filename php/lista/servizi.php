...
$sql = "SELECT * FROM servizi" . $type . " GROUP BY id_servizio ORDER BY id_servizio DESC LIMIT " . ($page - 1) * $elementsPerPage . ", " . $elementsPerPage;
$result = $conn->prepare($sql);
$result->execute();
$servizi = $result->fetchAll(PDO::FETCH_ASSOC);
