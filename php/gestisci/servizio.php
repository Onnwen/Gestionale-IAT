...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $sql = "SELECT * FROM servizi WHERE id_servizio = " . $id . ";";
    ...
    $sql = "DELETE FROM servizi WHERE id_servizio = " . $id . ";";
    $result = $conn->prepare($sql);
    ...
    $sql = "INSERT INTO servizi (nome, url_immagine, descrizione, tipologia, localita, longitudine, latitudine, telefono) VALUES (:nome, :url_immagine, :descrizione, :tipologia, :localita, :longitudine, :latitudine, :telefono);";
