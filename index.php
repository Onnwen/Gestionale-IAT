        ...
        <div class="wrapper">
            <nav style="position: fixed; left: 0; top: 0; height: 100%;" class="sidebar" id="sidebar">
                <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar">
                    ...
                    <hr>
                    <div class="nav nav-pills flex-column mb-auto d-grid gap-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active text-white text-start hover-button" id="v-pills-dashboard-tab" data-bs-toggle="pill" data-bs-target="#v-pills-dashboard" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                        ...
                        <button class="nav-link text-white text-start hover-button" id="v-pills-events-tab" data-bs-toggle="pill" data-bs-target="#v-pills-events" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                    ...
                    <div class="tab-pane fade" id="v-pills-events" role="tabpanel">
                        <div class="container px-4 py-5" id="events">
                            ...
                            <div class="row g-5 py-4 row-cols-1 row-cols-lg-2">
                                <div class="bigButton">
                                    <div style="padding-top: 110px;" class="feature-icon d-inline-flex align-items-center justify-content-center bg-gradient text-primary fs-1 mb-1">
...
?>
    ...
    <body class="text-center container d-flex align-items-center justify-content-center" style="height:100vh">
        <div>
            ...
            <a class="btn btn-primary mt-3 w-25" href="login.html?wrongCredentials=true">Riprova</a>
        </div>
    </body>
<?php
}
